...
public final class ActivityResultBinding implements ViewBinding {
  ...
  private ActivityResultBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnSave,
      @NonNull PhotoView photoView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultBinding((LinearLayout) rootView, btnSave, photoView, toolbar);
    }
